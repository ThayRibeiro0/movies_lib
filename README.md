...
## Referência
- [Youtube] - PROJETO DE FILMES COM REACT E API DO TMDB (REACT ROUTER, REACT HOOKS) | Matheus Battisti - Hora de Codar - (https://www.youtube.com/watch?v=XqxUHVVO7-U&list=PLnDvRpP8BneyVA0SZ2okm-QBojomniQVO&index=42)
